...
export function getProductLandingData(slug: ProductMarketSlug): ProductLandingData {
  ...
  if (slug === "blueskin") {
    return {
      ...
      checkoutIntro: "يرجى إدخال بياناتك بدقة لتسريع عملية التوصيل المجاني إلى باب بيتك.",
  ...
  if (slug === "qarskin") {
    return {
      ...
      checkoutIntro: "يرجى إدخال بياناتك بدقة لتسريع التوصيل داخل قطر إلى عنوانك.",
  ...
  return {
    ...
    checkoutIntro: "يرجى إدخال بياناتك بدقة لتسريع التوصيل داخل الكويت إلى عنوانك.",
