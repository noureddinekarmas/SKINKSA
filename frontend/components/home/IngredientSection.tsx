...
export default function IngredientSection() {
  return (
    <section className="py-20 bg-gradient-to-b from-indigo-950 to-[#0F172A] text-white">
      <div className="max-w-5xl mx-auto px-4">
        <div className="text-center mb-14">
          <span className="text-sm font-bold uppercase tracking-widest text-[#B7791F] bg-[#B7791F]/20 px-3 py-1 rounded-full">التركيبة الفاخرة</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {ingredients.map((ingredient) => (
            ...
            >
              <div className="mx-auto w-16 h-16 rounded-2xl bg-[#B7791F]/20 flex items-center justify-center mb-4">
                <ingredient.icon className="w-8 h-8 text-[#fcd34d]" />
              </div>
        ...
        <div className="mt-16 flex justify-center">
          <div className="bg-white/5 border border-[#B7791F]/30 rounded-3xl p-8 max-w-2xl text-center shadow-[0_0_40px_rgba(183,121,31,0.15)] flex flex-col md:flex-row items-center gap-6">
            <div className="w-full md:w-1/3">
              <Image
                src="/placeholders/copper-peptide-ingredient.svg"
            ...
            <div className="w-full md:w-2/3 text-right">
              <h4 className="text-xl font-bold text-[#fcd34d] mb-2">مرخص وآمن 100%</h4>
